...
<script>
    ...
    function day() {
        ...
        if (models.length == 18) {
            $('#model').css({"font-size":"25pt", "-moz-transform":"scale(1,1)","padding-top":"13px;"});
        }
    ...
    var printSettings = {
        ...
        "footerStrCenter": "",
        "footerStrRight": "",
        "printerName" : "SATO CL4NX Plus (203 dpi)"
    };

    function label_kecil2() {
        var sn = $('#codesn').val();
        window.open('{{ url("index/assembly/clarinet/label_kecil2") }}'+'/'+sn+'/P', '_blank');
        window.close();
    }
